...
const UPDATE_HISTORY = [
    {
        version: "2.0.3",
        date: "2026-05-31",
        content: "改善\n・ヘッダーのツールメニューに「勤怠詳細」ツールへのリンクを追加"
    },
    {
        version: "2.0.2",
        date: "2026-05-03",
        content: "改善\n・設定 → 共通タブのインストールセクションに手動インストール手順を追加\n　（AndroidやiOSでインストールバナーが出ない場合の案内）\n・運行記録の「車両持帰」ラベルを「車両持帰状況」に変更"
    },
    {
        version: "2.0.1",
        date: "2026-05-03",
        content: "改善\n・設定 → 共通タブに「ホーム画面に追加」ボタンを追加\n　（インストール可能なタイミングでのみ表示されます）"
    },
    {
        version: "2.0.0",
        date: "2026-05-03",
    ...
    },
    {
        version: "1.2.12",
        date: "2026-05-03",
        content: "訪問先・現場名の選択UIを大幅改善\n\n『ルートビルダー』型に変更しました。\n・「自宅」「会社」を一番上に固定追加\n・チップをタップするたびにルートに追加される方式に変更\n・同じ訪問先を何度でも選択可能\n・「一つ戻る」ボタンを追加（間違えてタップした際に便利）\n・「全クリア」ボタンでリセット\n・表示形式：「自宅→会社→前橋→会社」のような矢印区切りに変更"
    },
    {
        version: "1.2.11",
        date: "2026-05-03",
        content: "【重要】時刻の記録ズレ（タイムゾーンバグ）を修正\n\n■ 不具合の内容\nアルコールチェック・運行記録で「08:59以前」の時刻を入力して送信すると、スプレッドシートに保存される時刻が約9時間ズレる不具合がありました。\n例：08:00 と入力 → スプレッドシートには 23:00 と記録される\n\n■ 影響を受ける時刻\n・00:00〜08:59 → ❌ 約9時間前のUTC時刻が記録される（ズレる）\n・09:00〜23:59 → ✅ 正常に記録される（影響なし）\n\n■ 原因（技術的な詳細）\nGoogle スプレッドシートのGASは時刻データをUTC（世界標準時）で送信します。日本（JST）はUTC+9のため、朝9時より前の時刻は「前日のUTC」として扱われます。アプリ側でこの前日分のUTC補正が漏れていたため、そのままズレた時刻が表示・保存されていました。\n\n■ 対応が必要な場合\nこのバージョンより前に「朝9時より前」に入力・送信したデータがある場合、スプレッドシート上の時刻が正しくない可能性があります。該当日のデータを確認し、必要であれば手動で修正してください。"
    },
    {
        version: "1.2.10",
        date: "2026-05-03",
        content: "設定内のCSVファイル読込み時必ずエラーが出る不具合を修正"
    },
    {
        version: "1.2.9",
        date: "2026-03-28",
